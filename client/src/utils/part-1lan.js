export const language = {
  ...
  customer: ["Customer", "የደንበኛ አገልግሎት መስጫ", "", "", "", ""],
  checkStatus: ["Check status", "ሁኔታን ያረጋግጡ", "", "", "", ""],
  makeAccusation: ["Make Accusation", "ጥቆማ ያቅርቡ", "", "", "", ""],
  name: ["Name", "ስም", "", "", "", ""],
  subject: ["Subject", "ርዕሰ ጉዳይ", "", "", "", ""],
  phone: ["Phone", "ስልክ", "", "", "", ""],
  userManual: ["User Manual", "የደንበኞች አጋዥ ማንዋል", "", "", "", ""],
  ...
  division1: [
    "Land Design and Infrastructure Development",
    "የመሬት ዲዛይን እና የመሠረተ ልማት ግንባታ",
    "",
    "",
    "",
    "",
  ...
  division3: [
    "House Transfer and Construction Finance",
    "የቤት ማስተላለፍ እና የግንባታ ፋይናንስ",
    "",
    "",
    "",
    "",
  ...
  toManyRequests: [
    ...
    "ተደጋጋሚ ሙከራ አድርገዋል። እባክዎ ትንሽ ኮይተው ይሞክሩ።",
    "",
    "",
    "",
    "",
  ...
  checkSaving: ["Verifiy Saving", "የቁጠባ ሁኔታን ያረጋግጡ", "", "", "", ""],
  title: [
    "Housing Registration Status Tracker",
    "የጋራ መኖሪያ ቤት ተመዝጋቢዎች የምዝገባ መረጃ መከታተያ",
    "",
    "",
    "",
    "",
  ...
  subtitle: [
    "Verify your savings records using your bank account number",
    "የባንክ ሂሳብ ቁጥርዎን በመጠቀም የቆጣቢነት መረጃዎን ያረጋግጡ",
    "",
    "",
    "",
    "",
  ...
  enteryourUsername: [
    ...
    "ለመቀጠል የእርስዎን የተጠቃሚ ስም እና የይለፍ ቃል ያስገቡ",
    "",
    "",
    "",
    "",
  ...
  selectRelatedCaseNumber: [
    "Select Related Case Number",
    "ተዛማጅ የጉዳይ ቁጥር ይምረጡ",
    "",
    "",
    "",
  ...
  toStayConnected: [
    "To stay connected login back to your account with your credentials",
    "እንደተገናኙ ለመቆየት በማረጃዎችዎ ወደ መለያዎ ይመለሱ",
    "",
    "",
    "",
    "",
  ...
  oldest: ["Oldest", "የቆየ", "", "", "", ""],
  rateService: [
    "Are you statisfied with the service ?",
    "በአገልግሎቱ ምን ያህል ረክተዋል",
    "",
    "",
    "",
    "",
  ...
  errorConnectingtoServer: [
    "It seems like there was an error connecting to the server. Please try again later. Thank you for your patience.",
    " ከአገልጋዩ ጋር መገናኘት ላይ ስህተት ያለ ይመስላል። እባክዎ ቆየት ብለው ይሞክሩ፤ ስለትግስትዎ አናመሰግናለን",
    "",
    "",
    "",
    "",
  ...
  weCoudldNotFindThePage: [
    "We couldn't find the page you are looking for.",
    "የሚፈልጉትን ገጽ ማግኘት አልቻልንም",
    "",
    "",
    "",
    "",
  ...
  passwordMatch: [
    ...
    "የይለፍ ቃል እና የይለፍ ቃል ያረጋግጡ አይዛመዱም",
    "",
    "",
    "",
    "",
  ...
  edit: ["Edit", "አርትዕ", "", "", "", ""],
  archivalCategoryName: [
    "Archival Category Name",
    "የማህደር ምድብ ስም",
    "",
    "",
    "",
  ...
  addMembersToDirectorate: [
    "Add Members to directorate",
    "አባላትን ወደ ዳይሬክቶሬት ያክሉ",
  ],
  alreadyMembers: ["Already Members", "ቀድሞውኑ አባላት"],
  alreadyMembersToDirectorate: [
    "Already members to directorate",
    "ቀድሞውኑ አባላት ወደ ዳይሬክቶሬት",
  ],
  ...
  selectableValues: [
    "Does this question have selectable values",
    "ይህ ጥያቄ ሊመረጡ የሚችሉ እሴቶች አሉት?",
  ],
  yes: ["Yes", "አዎ"],
  no: ["No", "አይ"],
  text: ["Text", "ጽሑፍ"],
  ...
  enteryourCred: [
    ...
    "ለመቀጠል የመጠቀሚያ ስም አና የይለፍ ቃል  ያስገቡ",
  ],
  ...
  requriedInstructions: [
    "1. An asterisk (*) next to a question indicates that it is required.",
    "1. ከጥያቄ ቀጥሎ ያለው ኮከብ (*) ጥያቄው መሞላት/መመለስ እንዳለበት ይጠቁማል።",
    "",
    "",
    "",
    "",
  ...
  fileSizeInstuction: [
    "2. File size should not exceed 10MB",
    "2. ፋይል መጠን ከ10 ሜባ መብለጥ የለበትም።",
    "",
    "",
    "",
    "",
  ...
  mergeAllDocuments: [
    "3. Merge all documents into one pdf file.",
    "3. ሁሉንም ሰነዶች ወደ አንድ ፒዲኤፍ ፋይል ያዋህዱ",
    "",
    "",
    "",
    "",
  ],
  mergeAllDocumentsAttachment: [
    "Merge all documents into one pdf file.",
    "ሁሉንም ሰነዶች ወደ አንድ ፒዲኤፍ ፋይል ያዋህዱ",
    "",
    "",
    "",
    "",
  ...
  directoratesUnder: [
    "Directorates within this division",
    "በዚህ ዘርፍ ዉስጥ የሚገኙ ዳይሬክቶሬቶች",
    "",
    "",
    "",
    "",
  ],
  rate: ["Rate", "የአገልግሎቱን ደረጃ ይስጡ", "", "", "", ""],
  downloadAttachment: ["Download attachemnt", "አባሪውን ያውርዱ", "", "", "", ""],
  downloadResponse: [
  ...
  downloadFile: ["Download file", "ፋይሉን ያውርዱ", "", "", "", ""],
  ///////
  ...
  securityLookout: [
    "Security Lockout: Too many failed attempts. Please try again in 1 hour.",
    "የደህንነት እገዳ፦ ሙከራዎ ስለበዛ እባክዎን ከ1 ሰዓት በኋላ እንደገና ይሞክሩ።",
  ],
  noRecordFound: ["No Record Found", "ምንም ዓይነት መዝገብ አልተገኘም", "", "", "", ""],
  attemptsLeft: ["attempts left", "የቀሩ ሙከራዎች", "", "", "", "", ""],
  verificationResultWillAppear: [
    "Verification results will appear here",
    "የማረጋገጫ ውጤቶች እዚህ ይገለጻሉ",
    "",
    "",
    "",
  ],
  ...
  bankAccountNumber: ["Bank Account Number", "የባንክ ሂሳብ ቁጥር", "", "", "", ""],
  enterAccountNumber: [
  ...
  recordVerifiedSuccess: [
    ...
    "መዝገቡ በትክክል መኖሩ ተረጋግጧል",
    "",
    "",
    "",
    "",
  ],
  bankAccount: ["Bank Account", "የባንክ ሂሳብ", "", "", "", "", ""],
  fullname: ["Full Name", "ሙሉ ስም", "", "", "", "", ""],
  programType: ["Program Type", "የፕሮግራም ዓይነት", "", "", "", ""],
  verifyAnotherRecord: [
