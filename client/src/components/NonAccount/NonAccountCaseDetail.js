    ...
    <div className="w-[100%] bg-white">
      <div className="w-[90%] mx-auto">
        ...
        <div className="flex justify-between items-center gap-5">
          <div className="flex items-center justify-start gap-[10px] text-[#0067DA]">
            <BiChevronLeft
              onClick={() => navigate(-1)}
          ...
          <div className="w-[90%] mx-auto flex gap-[20px] max-[1200px]:flex-col">
            <div className="w-[50%] mt-[20px] flex flex-col gap-[30px] max-[1200px]:w-[100%] px-2">
              <div className="w-[100%] flex justify-between items-center gap-[20px] max-[600px]:flex-col ">
                <div className="w-[100%] mx-auto flex justify-between items-end gap-4">
                  <div className="flex flex-col gap-2 w-[100%]">
                    <p className="text-[#1C3F79] text-[15px] font-semibold">
                      Case Number
                    </p>
                    <p className="px-6 py-2 bg-gray-50 shadow-md font-semibold text-[15px] text-[#353535] border border-[#0067DA] rounded-md">
              ...
              <div className="w-[100%] flex justify-between items-center gap-[20px] max-[600px]:flex-col ">
                    ...
                    <p className="px-6 py-2 bg-gray-50 shadow-md font-semibold text-[15px] text-[#353535] border border-[#0067DA] rounded-md">
                      {caseInfo?.related_case_id ? (
                        <span>
                          {caseInfo?.related_case_id}{" "}
                          <span
                            className="text-[13px] cursor-pointer text-[#0067DA]"
                            onClick={() =>
                              navigate(
                ...
                <div className="flex flex-col gap-2 w-[100%]">
                  ...
                  <p className="px-6 py-2 bg-gray-50 shadow-md font-semibold text-[15px] text-[#353535] border border-[#0067DA] rounded-md capitalize">
              ...
              <div className="flex flex-col gap-2 w-[100%]">
                ...
                <p
                  className="px-6 py-2 bg-gray-50 shadow-md font-semibold text-[15px] text-[#353535] border border-[#0067DA] cursor-pointer rounded-md"
                  onClick={() =>
                ...
                >
                  ...
                  <span className="text-[12px] text-[#0067DA] font-semibold">
                    (Click to view)
                  </span>
                </p>
              </div>
                ...
                <div className="flex flex-col gap-2 w-[100%]">
                  ...
                  >
                    {caseInfo?.response_attachment
                      ? caseInfo?.response_attachment
                      : "-"}{" "}
                    <span className="text-[13px] text-[#0067DA] font-semibold">
                      (Click to view)
                    </span>
                  </p>
                </div>
              ...
              <div className="flex flex-col gap-2 w-[100%]">
                ...
                <div className="px-6 py-2 bg-gray-50 shadow-md font-semibold text-[15px] text-[#353535] border border-[#0067DA] rounded-md capitalize max-h-[100px] overflow-auto">
            ...
            <div className="w-[50%] mt-[20px] flex flex-col gap-[20px] max-[1200px]:mt-[0px] max-[1200px]:w-[100%]">
              <div className="w-[95%]  mx-auto">
                <div>
                  <span className="text-[#1C3F79] text-[15px] font-semibold">
                    {title}
                  </span>
                </div>
